            ...
            <div class="flex flex-col pt-3 mb-3">
                ...
                <div class="flex flex-row justify-between items-start w-full">
                    <div class="flex flex-col w-full mb-2 md:mb-3">
                        <span class="font-sans font-medium text-xs text-gray-800 text-wrap">Rosli Bin Abd
                            Rani</span>
                        <span class="font-sans font-normal text-xs text-gray-700 text-wrap italic">Bapa
                            pengantin
                            perempuan</span>
